...
smd(
 ...
 async m => {
  try {
   ...
   await m.error(error + '\n\ncommand: aesthetic', error, '*_No responce from API, Sorry!!_*')
  }
 }
)
smd(
 ...
 async m => {
  try {
   ...
   await m.error(error + '\n\ncommand: bike', error, '*_No responce from API, Sorry!!_*')
  }
 }
)
// Command 2: cr7
smd(
 ...
 async m => {
  try {
   ...
   await m.error(error + '\n\ncommand: cr7', error, '*_No responce from API, Sorry!!_*')
  }
 }
)
// Command 3: cat
smd(
 ...
 async m => {
  try {
   ...
   await m.error(error + '\n\ncommand: cat', error, '*_No responce from API, Sorry!!_*')
  }
 }
)
// Command 4: dog
smd(
 ...
 async m => {
  try {
   ...
   await m.error(error + '\n\ncommand: dog', error, '*_No responce from API, Sorry!!_*')
  }
 }
)
// Command 5: messi
smd(
 ...
 async m => {
  try {
   ...
   await m.error(error + '\n\ncommand: messi', error, '*_No responce from API, Sorry!!_*')
  }
 }
)
// Command 6: mlegend
smd(
 ...
 async m => {
  try {
   ...
   await m.error(error + '\n\ncommand: mlegend', error, '*_No responce from API, Sorry!!_*')
  }
 }
)
// Command 7: pubg
smd(
 ...
 async m => {
  try {
   ...
   await m.error(error + '\n\ncommand: pubg', error, '*_No responce from API, Sorry!!_*')
  }
 }
)
...
smd(
 ...
 async m => {
  try {
   ...
   await m.error(error + '\n\ncommand: random', error, '*_No responce from API, Sorry!!_*')
  }
 }
)
...
smd(
 ...
 async m => {
  try {
   ...
   await m.error(error + '\n\ncommand: car', error, '*_No responce from API, Sorry!!_*')
  }
 }
)
...
smd(
 ...
 async m => {
  try {
   ...
   await m.error(error + '\n\ncommand: blackpink', error, '*_No responce from API, Sorry!!_*')
  }
 }
)
// Command 11: dog
