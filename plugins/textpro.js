let { smd, prefix, Config, fetchJson } = require('../lib')
...
async function textToLogoGenerator(
 ...
 let mumakerResponse = {}
 let apiResponse = {}
 let url = /1|ephoto|ephoto360/gi.test(serviceType)
  ? `https://ephoto360.com/${textProUrl}.html`
  : /2|potoxy|photooxy/gi.test(serviceType)
  ? `https://photooxy.com/${textProUrl}.html`
  : /3|enphoto|en360/gi.test(serviceType)
  ? `https://en.ephoto360.com/${textProUrl}.html`
 ...
 try {
  ...
  try {
   ...
   await message.bot.sendMessage(
    message.jid,
    { image: { url: apiResponse.img } },
    { messageId: message.bot.messageId() }
   )
  } catch (err) {
   let imageUrl =
    mumakerResponse && mumakerResponse.image
     ? mumakerResponse.image
...
smd(
 ...
 async (message, match, { cmdName }) => {
  try {
   if (!match) return message.reply(`*_Example : ${prefix + cmdName} Astro_*`)
   return await textToLogoGenerator(message, 'tao-hieu-ung-chu-digital-glitch-truc-tuyen-941', match, 'asta', '1')
  } catch (e) {
   return await message.error(`${e}\n\ncmdName: ${cmdName}`, e)
  }
 }
...
smd(
 ...
 async (message, match, { cmdName }) => {
  try {
   if (!match) return message.reply(`*_Example : ${prefix + cmdName} Astro_*`)
   return await textToLogoGenerator(message, 'tao-hieu-ung-chu-pixel-glitch-truc-tuyen-940', match, 'asta', '1')
  } catch (e) {
   return await message.error(`${e}\n\ncmdName: ${cmdName}`, e)
  }
 }
...
smd(
 ...
 async (message, match, { cmdName }) => {
  try {
   if (!match) return message.reply(`*_Example : ${prefix + cmdName} Astro_*`)
   return await textToLogoGenerator(message, 'hieu-ung-chu/chu-graffiti-online-mau-8-182', match, 'asta', '1')
  } catch (e) {
   return await message.error(`${e}\n\ncmdName: ${cmdName}`, e)
  }
 }
...
smd(
 ...
 async (message, match, { cmdName }) => {
  try {
   ...
   return await textToLogoGenerator(message, 'tao-hieu-ung-chu-graffiti-sieu-ngau-online-794', text1, text2)
  } catch (e) {
   return await message.error(`${e}\n\ncmdName: ${cmdName}`, e)
  }
 }
...
smd(
 ...
 async (message, match, { cmdName }) => {
  try {
   ...
   return await textToLogoGenerator(message, 'hieu-ung-chu/tao-cover-graffiti-online-181', text1, text2 || 'ser', '1')
  } catch (e) {
   return await message.error(`${e}\n\ncmdName: ${cmdName}`, e)
  }
 }
...
smd(
 ...
 async (message, match, { cmdName }) => {
  try {
   ...
   let text2 = match ? match.split(';')[1] : ''
   if (!text2 || !text1) return await message.reply(`*_Example : ${prefix + cmdName} text1;text2_*`)
   return await textToLogoGenerator(message, 'tao-logo-3d-phong-cach-avengers-445', text1, text2, '1')
  } catch (e) {
   return await message.error(`${e}\n\ncmdName: ${cmdName}`, e)
  }
 }
...
smd(
 ...
 async (message, match, { cmdName }) => {
  try {
   ...
   let text2 = match ? match.split(';')[1] : ''
   if (!text2 || !text1) return await message.reply(`*_Example : ${prefix + cmdName} text1;text2_*`)
   return await textToLogoGenerator(message, 'tao-logo-phong-cach-marvel-419', text1, text2, '1')
  } catch (e) {
   return await message.error(`${e}\n\ncmdName: ${cmdName}`, e)
  }
 }
