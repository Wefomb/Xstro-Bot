...
function pinterest(_0x2f8ba8) {
 return new Promise(async (_0x291602, _0x50133a) => {
  axios
   .get('https://id.pinterest.com/search/pins/?autologin=true&q=' + _0x2f8ba8, {
    headers: {
     cookie:
...
function wikimedia(_0x1868ba) {
 return new Promise((_0x2bc707, _0xd97134) => {
  axios
   .get('https://commons.wikimedia.org/w/index.php?search=' + _0x1868ba + '&title=Special:MediaSearch&go=Go&type=image')
   .then(_0x1f54aa => {
...
function ffmpeg(_0x3f259d, _0x31af2c = [], _0x5729b0 = '', _0x357d10 = '') {
 return new Promise(async (_0xba570a, _0x502055) => {
  try {
   ...
   spawn('ffmpeg', ['-y', '-i', _0x5a9045, ..._0x31af2c, _0x2352fa])
    .on('error', _0x502055)
    .on('close', async _0xf77d97 => {
     try {
...
if (fs.existsSync('./source/' + Config.LANG + '.json')) {
 ...
 var json = JSON.parse(fs.readFileSync('./source/utils.json'))
}
function ffancy(_0x48e16e) {
 return new Promise((_0x321dba, _0x34268c) => {
  axios.get('http://qaz.wtf/u/convert.cgi?text=' + _0x48e16e).then(({ data: _0x3a4376 }) => {
...
async function isAdmin(_0x234375, _0x5b87cc, _0x509e42) {
 ...
 let _0x4f5480 = _0x44a379.participants.reduce(
  (_0x598567, _0x16141e) =>
   (_0x16141e.admin
    ? _0x598567.push({
       id: _0x16141e.id,
...
async function sync() {
 ...
 _0x3f267e.all.map(_0x4602cd => {
  _0x3af3b6 +=
   '● [' + _0x4602cd.date.substring(0, 10) + ']: ' + _0x4602cd.message + '\n- By:' + _0x4602cd.author_name + '\n'
 })
 return _0x3af3b6
}
function ringtone(_0x2fc4c5) {
 return new Promise((_0x28e1d8, _0x2d6a77) => {
  axios.get('https://meloboom.com/en/search/' + _0x2fc4c5).then(_0x3dc63c => {
   ...
   ).each(function (_0x212a7f, _0x2abbe0) {
    _0x450043.push({
...
function styletext(_0x546f44) {
 return new Promise((_0x452fff, _0xb199b7) => {
  axios.get('http://qaz.wtf/u/convert.cgi?text=' + _0x546f44).then(({ data: _0x52dd9a }) => {
...
function adultvid() {
 return new Promise((_0x75660e, _0x481c10) => {
  axios.get('https://tikporntok.com/?random=1').then(_0x2aa3c0 => {
   ...
   _0x10ea21.thumb =
    _0x5a9f62('article > div.video-wrapper.vxplayer > div.vx_el').attr('data-poster') ||
   ...
   _0x10ea21.video =
    _0x5a9f62('article > div.video-wrapper.vxplayer > div.vx_el').attr('src') ||
    _0x5a9f62('article > div.video-wrapper.vxplayer > div.vx_el').attr('data-src') ||
    'https://4.bp.blogspot.com/-hyMqjmQQq4o/W6al-Rk4IpI/AAAAAAAADJ4/m-lVBA_GC9Q5d4BIQg8ZO3fYmQQC3LqSACLcBGAs/s1600/404_not_found.png'
   _0x75660e(_0x10ea21)
  })
 })
...
async function Insta(_0x492c6f) {
 ...
 try {
  ...
  const { data: _0x5c0f46 } = await axios('https://downloadgram.org/', {
   method: 'POST',
   data: _0x42cb1e,
  })
...
const mediafireDl = async _0x3c3223 => {
 ...
 const _0x2c0400 = _0x283931('a#downloadButton')
  .text()
  .replace('Download', '')
  .replace('(', '')
  .replace(')', '')
